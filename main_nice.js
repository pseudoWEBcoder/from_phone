//$ js-beautify main.js >main_nice.js from https://www.npmjs.com/package/js-beautify
try {
    (function(window, document) {
            ...
            foldOptions: {
                widget: (from, to) => {
                    ...
                    try {
                        ...
                        var type = 'type' in parsed ? parsed.type.toString().substring(0, 30) : '';
                        var text = 'text' in parsed ? parsed.text.toString().substring(0, 30) : '';
                        count = [type, text, Object.keys(parsed).length].join(' ');
        ...
        function _alert(message, required) {
            ...
            if (debug || required) {
                // message = typeof message == 'string' ? message : JSON.stringify(obj, null, ' ');
        ...
        url = '/trash/news (3).json';
//url='https://idaprikol.ru/api/news?limit=100';
        a.href = url;
        a.innerHTML = url;
                ...
                try {
                    ...
                    function item(v, li, ul) {
                        ...
                        if (type == 'reply_for_comment') {
                            ...
                            if ('comment' in v) {
                                if ('id' in v.comment) { //document.write(JSON.stringify(v.comment));
                                    //c=new Comment (v.comment); 
